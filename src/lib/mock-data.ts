...
export const seedUsers: User[] = [
  { id: "u1", name: "Admin User", email: "admin@vendorb.io", role: "Admin" },
  { id: "u2", name: "Priya Nair", email: "priya@vendorb.io", role: "Procurement Officer" },
  { id: "u3", name: "Devansh Roy", email: "contact@helixtech.com", role: "Vendor", vendorId: "v3" },
  { id: "u4", name: "Manager Rao", email: "rao@vendorb.io", role: "Manager" },
];
