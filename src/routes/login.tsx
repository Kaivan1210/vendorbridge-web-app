...
export const Route = createFileRoute("/login")({
  head: () => ({ meta: [{ title: "Sign in — VendorB" }] }),
  component: LoginPage,
});
...
export default function LoginPage() {
  ...
  const onLogin = (e: React.FormEvent) => {
    e.preventDefault();
    login(email === "you@company.com" ? "admin@vendorb.com" : email, role);
  ...
  return (
    <div className="min-h-screen flex bg-[#1a0e17] font-sans text-slate-100 overflow-hidden">
      ...
      <div className="hidden lg:flex lg:w-[55%] flex-col justify-between relative px-10 py-8 overflow-hidden max-h-screen">
        ...
        <div className="absolute inset-0 pointer-events-none z-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-[#1a0e17] via-[#1a0e17]/90 to-transparent" />
          <div className="absolute top-[20%] left-[10%] w-80 h-80 bg-purple-500/10 rounded-full blur-[100px]" />
          <div className="absolute bottom-[20%] right-[10%] w-80 h-80 bg-fuchsia-500/10 rounded-full blur-[100px]" />
        </div>

        {/* Top Logo */}
        <div className="relative z-10 flex items-center gap-3">
          <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-[#714B67] shrink-0">
            <Boxes className="h-5 w-5 text-white" />
          </div>
          <div>
            <div className="text-white text-xl font-semibold tracking-tight leading-none">VendorB</div>
            <div className="text-[#8a5f80] text-[9px] tracking-widest font-semibold uppercase mt-0.5">Procurement ERP</div>
          </div>
        </div>
        ...
        <div className="relative z-10 max-w-xl mt-6">
          <h1 className="text-[2.75rem] font-bold leading-[1.1] tracking-tight mb-4 text-white">
            Run procurement <br />
            like a <span className="text-[#8a5f80]">finely<br/>tuned supply chain.</span>
          </h1>
          ...
          <ul className="space-y-3.5">
            {[
              ...
              <li key={i} className="flex items-center gap-3">
                <div className="flex h-8 w-8 items-center justify-center rounded-full border border-[#714B67]/40 bg-[#714B67]/15 text-[#8a5f80] shrink-0">
        ...
        <div className="relative z-10 mt-auto pt-6">
          <div className="flex flex-wrap gap-6 sm:gap-8 pb-4 border-b border-white/10">
            <div>
              <div className="flex items-center gap-1.5 text-[#8a5f80] mb-0.5">
            ...
            <div>
              <div className="flex items-center gap-1.5 text-[#8a5f80] mb-0.5">
                <div className="flex h-4 w-4 items-center justify-center rounded-full border border-[#8a5f80] text-[10px]">₹</div>
          ...
          <div className="pt-4 text-[11px] text-slate-500 font-medium">
            © {new Date().getFullYear()} VendorB. All rights reserved.
          </div>
        </div>
      </div>
          ...
          {screen === "login" ? (
            <div className="py-2">
              ...
              <form onSubmit={onLogin} className="space-y-4">
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full h-10 rounded-lg border border-slate-200 px-3 text-sm text-slate-900 placeholder-slate-400 focus:outline-none focus:border-[#714B67] focus:ring-1 focus:ring-[#714B67] transition-colors bg-white"
                      required
                    />
                ...
                <div className="flex justify-end -mt-1">
                  <a href="#" className="text-xs font-semibold text-[#714B67] hover:text-[#5a3a52]">Forgot password?</a>
                </div>
                      ...
                      return (
                        <div
                          ...
                          className={`relative cursor-pointer rounded-xl border p-3 transition-all ${
                            isActive 
                              ? "border-[#714B67] bg-[#f5eef3] shadow-sm" 
                              : "border-slate-200 hover:border-slate-300 bg-white"
                          }`}
                        >
                          {isActive && (
                            <div className="absolute top-3 right-3 h-4 w-4 bg-[#714B67] rounded-full flex items-center justify-center">
                          ...
                          <div className={`flex h-8 w-8 items-center justify-center rounded-lg mb-2 ${isActive ? "bg-white shadow-sm" : "bg-slate-100"}`}>
                            <r.icon className={`h-4 w-4 ${isActive ? "text-[#714B67]" : "text-slate-600"}`} />
                          </div>
                ...
                <div className="flex items-center justify-between pt-1">
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input type="checkbox" className="w-3.5 h-3.5 rounded border-slate-300 text-[#714B67] focus:ring-[#714B67]" />
                ...
                <button
                  type="submit"
                  className="w-full h-10 flex items-center justify-center gap-2 rounded-lg bg-[#714B67] hover:bg-[#5a3a52] text-white text-sm font-semibold transition-colors mt-2"
                >
              ...
              <div className="mt-5 text-center pt-4 border-t border-slate-100">
                <span className="text-[13px] text-slate-500">New to VendorB? </span>
                <button onClick={() => setScreen("register")} className="text-[13px] font-semibold text-[#714B67] hover:text-[#5a3a52]">
                  Sign up
                </button>
              </div>
            </div>
            ...
            <div className="py-2">
              ...
              <form onSubmit={onRegister} className="space-y-3.5">
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-1">
                    ...
                    <input type="text" value={firstName} onChange={(e) => setFirstName(e.target.value)} className="w-full h-10 rounded-lg border border-slate-200 px-3 text-sm text-slate-900 placeholder-slate-400 focus:outline-none focus:border-[#714B67] focus:ring-1 focus:ring-[#714B67] transition-colors bg-white" required />
                  </div>
                  <div className="space-y-1">
                    <label className="text-[13px] font-semibold text-slate-900">Last Name</label>
                    <input type="text" value={lastName} onChange={(e) => setLastName(e.target.value)} className="w-full h-10 rounded-lg border border-slate-200 px-3 text-sm text-slate-900 placeholder-slate-400 focus:outline-none focus:border-[#714B67] focus:ring-1 focus:ring-[#714B67] transition-colors bg-white" required />
                  </div>
                </div>

                <div className="space-y-1">
                  <label className="text-[13px] font-semibold text-slate-900">Email address</label>
                  <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} className="w-full h-10 rounded-lg border border-slate-200 px-3 text-sm text-slate-900 placeholder-slate-400 focus:outline-none focus:border-[#714B67] focus:ring-1 focus:ring-[#714B67] transition-colors bg-white" required />
                </div>

                <div className="space-y-1">
                  <label className="text-[13px] font-semibold text-slate-900">Password</label>
                  <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} className="w-full h-10 rounded-lg border border-slate-200 px-3 text-sm text-slate-900 placeholder-slate-400 focus:outline-none focus:border-[#714B67] focus:ring-1 focus:ring-[#714B67] transition-colors bg-white" required />
                </div>
                    ...
                    {ROLES.map((r) => {
                      ...
                      return (
                        <div
                          ...
                          onClick={() => setRole(r.id)}
                          className={`relative cursor-pointer rounded-xl border p-3 transition-all ${
                            isActive ? "border-[#714B67] bg-[#f5eef3] shadow-sm" : "border-slate-200 hover:border-slate-300 bg-white"
                          }`}
                        >
                          {isActive && (
                            <div className="absolute top-3 right-3 h-4 w-4 bg-[#714B67] rounded-full flex items-center justify-center">
                ...
                <button type="submit" className="w-full h-10 flex items-center justify-center gap-2 rounded-lg bg-[#714B67] hover:bg-[#5a3a52] text-white text-sm font-semibold transition-colors mt-2">
                  Create Account
                </button>
              </form>
              ...
              <div className="mt-5 text-center pt-4 border-t border-slate-100">
                ...
                <button onClick={() => setScreen("login")} className="text-[13px] font-semibold text-[#714B67] hover:text-[#5a3a52]">
                  Sign in
                </button>
              </div>
            </div>
