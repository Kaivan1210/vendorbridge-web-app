...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "VendorB — Procurement & Vendor Management ERP" },
      { name: "description", content: "End-to-end procurement: vendors, RFQs, quotations, approvals, POs, invoices, and analytics." },
      { property: "og:title", content: "VendorB — Procurement & Vendor Management ERP" },
      { name: "twitter:title", content: "VendorB — Procurement & Vendor Management ERP" },
